...
cdef class StatisticalOutlierRemovalFilter_PointCloud2:
    """
    Filter class uses point neighborhood statistics to filter outlier data.
    """
    cdef pcl_fil.StatisticalOutlierRemoval_PCLPointCloud2 *me

    def __cinit__(self, PCLPointCloud2 pc not None):
        self.me = new pcl_fil.StatisticalOutlierRemoval_PCLPointCloud2()
    ...
    property negative:
        def __get__(self):
            return (<pcl_fil.FilterIndices[cpp.PCLPointCloud2]*>self.me).getNegative()
        def __set__(self, bool neg):
            (<pcl_fil.FilterIndices[cpp.PCLPointCloud2]*>self.me).setNegative(neg)
    ...
    def set_InputCloud(self, PCLPointCloud2 pc not None):
        (<cpp.PCLBase_PCLPointCloud2*>self.me).setInputCloud (pc.thisptr_shared)
    ...
    def set_negative(self, bool negative):
        ...
        Set whether the indices should be returned, or all points except the indices.
        """
        (<pcl_fil.FilterIndices[cpp.PCLPointCloud2]*>self.me).setNegative(negative)
