...
cdef class PointCloudColorHandleringGenericField:
    ...
    def __assign_PCLPointCloud2__(self, _pcl.PCLPointCloud2 pc, bytes field):
        sp_assign(self.thisptr_shared, <void*> new pcl_vis.PointCloudColorHandlerGenericField_PCLPointCloud2(pc.thisptr_shared, field))
    
    def __assign__(self, _pcl.PointCloudTypes pc, bytes field):
        sp_assign(self.thisptr_shared, pcl_vis.pcl_visualization_newPointCloudColorHandlerGenericField(pc.thisptr_shared, field))
