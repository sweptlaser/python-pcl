...
cdef extern from "typedeferral.h":
    ...
    bool pcl_visualization_PCLVisualizer_addPointCloud [PointCloudPtrT] (PCLVisualizer &visual, const PointCloudPtrT &cloud, const PointCloudColorHandler[cpp.PointXYZ] &color_handler, string id, int viewport)
